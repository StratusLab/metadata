...
public class X509UtilsTest {
  ...
  public static X509Certificate generateV1Certificate(String dn, KeyPair keyPair)
      throws Exception {
  ...
  public static X509Certificate generateV3Certificate(String dn,
      X509Certificate caCert, PrivateKey caKey, KeyPair keyPair, String email)
      throws Exception {
    ...
    certGen.addExtension(BasicConstraints, true, new BasicConstraints(false));
