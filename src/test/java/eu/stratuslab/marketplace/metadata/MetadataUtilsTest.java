...
public class MetadataUtilsTest {
  ...
  public void checkInvalidIdentifier1() {
    String[] invalidIds = new String[] { "A", "AAAAAAAAAAAAAAAAAAAAAAAAAAAA",
  ...
  public void endorsementNotReplaced() {
    ...
    NodeList nl = doc.getElementsByTagNameNS("http://example.org/", "marker");
    if (nl.getLength() != 1) {
  ...
  public void endorsementWithInvalidEmail() throws Exception {
    ...
    Document doc = readDocument("autogen-endorsement-done.xml");
    X509Info x509info = getX509InfoWithoutEmail();
    MetadataUtils.fillEndorsementElement(doc, x509info, "not@a@valid@address");
  ...
  private static X509Info getX509Info() {
    ...
    InputStream is = MetadataUtilsTest.class.getResourceAsStream("test.p12");
