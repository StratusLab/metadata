...
public class ValidateMetadataConstraintsTest {
  ...
  public void checkInvalidDocuments() {
    ...
    String[] names = { "invalid-inconsistent-identifiers.xml",
        "invalid-inconsistent-checksum.xml", "invalid-bad-xml-base.xml",
        "invalid-multiple-deprecated.xml",
        "invalid-multiple-serial-numbers.xml", "invalid-multiple-versions.xml",
        "invalid-multiple-os.xml", "invalid-multiple-os-arch.xml",
